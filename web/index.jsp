    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <p style="margin-left: 30px;display: none" class="manage">
            <a class="meun-item" href="member.html" aria-controls="char" target="right">
                <img src="images/icon_chara_grey.png">成员管理</a></p>

        <p style="margin-left: 20px">
            <a class="meun-item" href="role.jsp" aria-controls="char" target="right"><img
                    src="images/icon_user_grey.png">角色管理
            </a></p>


        <p style="margin-left: 20px">
            <a class="meun-item" aria-controls="user" role="tab" data-toggle="tab" id="cout">
        ...
        <!--<a class="meun-item" href="Dept.html" aria-controls="chan" role="tab" target="right"><img-->
